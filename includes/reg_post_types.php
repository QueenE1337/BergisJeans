...
function products_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Products', 'Post Type General Name', 'post_theme' ),
		'singular_name'         => _x( 'Product', 'Post Type Singular Name', 'post_theme' ),
		'menu_name'             => __( 'Products', 'post_theme' ),
		'name_admin_bar'        => __( 'Post Type', 'post_theme' ),
		'archives'              => __( 'Products Archives', 'post_theme' ),
		'attributes'            => __( 'Product Attributes', 'post_theme' ),
		'parent_item_colon'     => __( 'Parent Item:', 'post_theme' ),
		'all_items'             => __( 'All Products', 'post_theme' ),
		'add_new_item'          => __( 'Add New Products Item', 'post_theme' ),
		'add_new'               => __( 'Add New', 'post_theme' ),
		'new_item'              => __( 'New Item', 'post_theme' ),
		'edit_item'             => __( 'Edit Item', 'post_theme' ),
		'update_item'           => __( 'Update Item', 'post_theme' ),
	...
	$args = array(
		'label'                 => __( 'Product', 'post_theme' ),
		'description'           => __( 'Bergis products', 'post_theme' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ),
		'taxonomies'            => array( 'product_material', ' product_size', ' product_model', ' product_sex' ),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
